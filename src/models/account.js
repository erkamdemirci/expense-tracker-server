...
const accountSchema = new mongoose.Schema(
  {
    ...
    balance: {
      ...
      validate: {
        ...
        message: (props) =>
          `Balance is required for account type ${props.type}`,
      },
    },
    limit: {
      type: Number,
    ...
    statementDate: {
      ...
      validate: {
        ...
        message: (props) =>
          `Statement date is required for account type ${props.type}`,
      },
    },
    statementDueDate: {
      type: Date,
      validate: {
        ...
        message: (props) =>
          `Statement due date is required for account type ${props.type}`,
      },
    },
    transactions: [
      {
